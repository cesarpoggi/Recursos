...
fig <- plot_ly(dataCASOSACU, type = 'scatter', mode = 'lines', stackgroup = 'one')%>%
  ...
  layout(showlegend = T)
#Para crear gráficos de linea de dos variables con leyenda. PLOTLY.

fig1 <- plot_ly(y = dataP$survey_mins1, name = "TRACE 0",  type = "box") %>%
  add_trace(y = dataP$`QUEJAS/survey_mins4`, name = "TRACE 1",  type = "box" ) %>%
#Para crear gráficos de caja de una varaible. PLOTLY.
...
#Usado para grafico de barras superpuestas o histogramas. Generalmente al final del plot.
...
#Nos da un gráfico de linrs, se puede cambiar el nombre de la variable y especificar el ancho de la línea.
```
