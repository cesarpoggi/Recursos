...
```{r}
sqrt(x)
#Nos da la raíz cuadrada de cada elemento de la matríz

x^3
#Eleva cada elemento de la matríz a la 3
```
...
#Forma un objeto con 50 variables numericas random. Además, podemos especificar su media y su deviación estandar. Aunque no es encesario.
